...
export default function Information() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.put('https://ask-rashana-server.vercel.app/api/users/update', formData, {
        headers: {
  ...
  return (
    <div className="relative min-h-screen montserrat-alternates-regular">
      <div className="relative flex flex-col items-center justify-center p-4 pt-36">
        <div className="w-full max-w-md p-8 rounded-lg shadow-lg border border-gray-700 bg- bg-opacity-10">
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              <select
                id="division"
                className="w-full p-3 border border-black rounded-lg bg-transparent text-black placeholder-gray-400"
