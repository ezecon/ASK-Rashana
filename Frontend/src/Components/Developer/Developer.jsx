        ...
        <section id="hero" className="relative">
          <div className="hero container max-w-xl mx-auto px-4">
            <div>
              ...
              <a href="https://portfolio-beta-omega.vercel.app/" onClick={handleDownload} className="cta rounded inline-block mt-6 md:mt-10 py-2 px-6 text-lg md:text-xl">About  Me?</a>
            </div>
          </div>
        </section>
      </div>
